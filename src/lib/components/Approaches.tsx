...
import { Add, AddCircleOutline, QuizOutlined } from '@mui/icons-material';
...
export default function Approaches() {
    ...
    return (
        ...
        <ApproachCards approaches={approaches} activeCardId={activeCardId} handleCardClick={handleCardClick} />
        </>
    );
}